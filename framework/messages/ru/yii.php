...
return array (
  ...
  '{attribute} cannot be blank.' => 'Необходимо заполнить поле: <strong>&laquo;{attribute}&raquo;</strong>.',
  '{attribute} is in the list.' => '{attribute} находится в списке.',
  '{attribute} is invalid.' => '<strong>&laquo;{attribute}&raquo;</strong> не верен.',
  ...
  '{attribute} is of the wrong length (should be {length} characters).' => '<strong>&laquo;{attribute}&raquo;</strong> неверной длины (Должен быть <strong>{length}</strong> симв.).',
