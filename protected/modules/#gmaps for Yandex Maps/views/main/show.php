			...
			<? foreach($params_list as $key => $value): ?>
				<? if($value['data_type_id']==1): ?>
					<div class="edit_line">
						...
						<div class="inpC">
							<input class="inp" size="60" maxlength="255" name="ModuleGmapsParams[<?=$value['id']?>]" id="ModuleGmapsParams_<?=$value['code']?>" type="text" value="<?=(isset($params_values_list[$value['id']]))?$params_values_list[$value['id']]['value']:''?>">
						</div>
					</div>
				<? endif; ?>
				<? if($value['data_type_id']==2): ?>
					<div class="edit_line checkboxLine">
						...
						<input name="ModuleGmapsParams[<?=$value['id']?>]" id="ModuleGmapsParams_<?=$value['code']?>" value="1" type="checkbox" <?=(isset($params_values_list[$value['id']]) && $params_values_list[$value['id']]['value']==1)?'checked':''?>>
