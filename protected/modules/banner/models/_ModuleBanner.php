...
{
	public $img = array();
	public $img_default = array('/pics/no_image_banner.png');
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('img_id, active', 'numerical', 'integerOnly'=>true),
			array('title', 'length', 'max'=>255),
			array('order_id', 'length', 'max'=>11),
			array('text', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, title, text, img_id, active, order_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'img' => array(self::BELONGS_TO, 'RktvFiles', 'img_id'),
		);
	}
