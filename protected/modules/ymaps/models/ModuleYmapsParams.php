...
/**
 * This is the model class for table "rktv_module_ymaps_params".
 *
 * The followings are the available columns in table 'rktv_module_ymaps_params':
 * @property string $id
 ...
 */
class ModuleYmapsParams extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ModuleYmapsParams the static model class
	 */
	...
	{
		return 'rktv_module_ymaps_params';
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'moduleYmapsValues' => array(self::HAS_MANY, 'ModuleYmapsValues', 'param_id'),
		);
	}
