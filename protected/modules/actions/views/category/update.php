<h1 class="pTitle">Редактирование категории акций</h1>
<div class="actionsList">
    ...
    <a href="<?php echo Yii::app()->baseUrl; ?>/admin.php?r=<?php echo $this->module->id;?>/category/create&page_id=<?php echo $page_id;?>">Добавить категорию</a>
