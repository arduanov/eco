	...
	?>
            ...
            array(
                ...
                'config'=>array(
                    ...
                    'sizeLimit' => '40960000',
                    'onComplete'=>"js:function(id, fileName, responseJSON){ $('#ModuleList3Files_file_id').html('<a href=\'/upload/".md5($this->module->id)."/'+responseJSON.filename+'\' />'); $('#ModuleList3Files_file_id').val(responseJSON.image_id); }"
                ),
            ));
            ?>
            </div>
