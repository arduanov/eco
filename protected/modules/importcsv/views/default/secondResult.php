...
elseif($error==0){
    ...
    $modeOption4 = '<option value=\"4\" '.$selected4.'>'.Yii::t('importcsvModule.importcsv', 'Replace old').'</option>';

    $modeContent = '<select name=\"Mode\" id=\"Mode\">'.$modeOption1.$modeOption2.$modeOption3.$modeOption4.'</select>';
