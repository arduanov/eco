...
<div id="importCsvSteps">
    ...
    <div id="importCsvSecondStep">
        ...
        <br/><br/>
        <?php
        echo CHtml::ajaxSubmitButton(Yii::t('importcsvModule.importcsv', 'Update'), '', array(
    ...
    <br/>
    <span id="importCsvBread1">&laquo; <?php echo CHtml::link(Yii::t('importcsvModule.importcsv', 'Start over'), "/admin.php?r=/importcsv/default/");?></span>
